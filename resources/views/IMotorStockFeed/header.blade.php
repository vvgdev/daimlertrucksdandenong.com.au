    ...
    <header id="layout-header" class="header">
        <div class="container">
            ...
            <div class="row desktop-nav">
                ...
                <div class="col-md-8">
                    <a class="pull-left" href="https://www.velocitytruckcentres.com.au/"><img class="vtc-logo" src="{{env('IMOTOR_URL')}}/images/vtc_logo.png" /></a>
                    <div class="pull-right">
                        <p class="emergency-contact clear-both">24/7 Emergency Roadside Assistance: <br> Trucks: <a href="tel:1800 033 557">1800 033 557</a></p>
                        <a href="{{env('IMOTOR_URL')}}/elite-support" title="Elite Support" class="pull-right mt-1"><img class="elite-logo " src="{{env('IMOTOR_URL')}}/images/elite-logo.png" width="60"></a>
                        <ul class="company-links">
                            ...
                            <li class="mr-0"><a href="{{env('IMOTOR_URL')}}/contact-us#contact_tab_id"><i class="fa fa-phone"></i>Contact us </a> </li>
                        </ul>
                    </div>
                    <nav class="topmenu">
