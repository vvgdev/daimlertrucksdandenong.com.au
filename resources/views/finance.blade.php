    ...
    <div class="finance-page page-multi mt-5">
        <div class="container">
            ...
            <div class="content para">
                ...
                <p class="mt-5 pt-5">
                    <strong class="bold">Please feel free to use our <a href="/contactus#finance_tab_id">online form</a> to get a quick and accurate response on financing your next truck.</strong>
                </p>
                <p>
                    <strong class="bold">Our Business Manager has a great knowledge of all the above products and is available to discuss your business finance needs.</strong>
                </p>
                <h3 class="mt-5 pt-5">DISCLAIMER:</h3>
                <p>
