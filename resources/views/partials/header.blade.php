            ...
            <div class="col-md-8">
                ...
                <div class="pull-right">
                    ...
                    <ul class="company-links clear-both">
                        <li class=""></li><li class="careers-link"><a href="https://www.velocitytruckcentres.com.au/careers" target="_blank"><i class="fa fa-user"></i>Careers</a> </li><li class=""><a href="/about-us"><i class="fa fa-info"></i>About us</a> </li><li class="mr-0"><a href="/contact-us#contact_tab_id"><i class="fa fa-phone"></i>Contact us </a> </li>
                    </ul>
                </div>
                <nav class="topmenu">
