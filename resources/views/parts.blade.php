            ...
            <div class="specification-tabs">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="benz_tab">
                        <h3 class="page-heading mb-4">Mercedes-Benz Truck Parts Melbourne South | Truck Parts Melbourne, VIC</h3>
                        ...
                        <h6>Always insist on Mercedes-Benz Genuine Parts.</h6>
                        ...
                        <p><strong>Dandenong Mercedes-Benz Trucks's</strong> qualified after sales personnel have the latest tools and equipment at their disposal to ensure they obtain the right part for the job, and that it will be fitted correctly.</p>
                    ...
                    <div class="tab-pane" id="freightliner_tab">
                        <h3 class="page-heading mb-4">Freightliner Truck Parts Melbourne South | Truck Parts Melbourne, VIC</h3>
                        <h6 class="mb-3">After Hours Support Hotline - <a href="tel:1300 244 744">1300 244 744</a> - Available 24 hours</h6>
                        <h6>Additional Service & Parts Agents:</h6>
                        <div class="mb-4">
                            <div style="width:49%;display:inline-block">
                        ...
                        <p>These parts are made specifically to fit your truck model and application needs, using only the highest quality materials and latest design and engineering enhancements. Thanks to <strong>Daimler Trucks Dandenong Freightliner</strong> using Genuine Freightliner Parts, every part of your truck remains a genuine Freightliner for years to come.</p>
                    ...
                    <h3 class="page-heading mb-4">Fuso Truck Parts Melbourne South | Truck Parts Melbourne, VIC</h3>
                    <h6 class="mb-3">After Hours Support Hotline - <a href="tel:1300 244 744">1300 244 744</a> - Available 24 hours</h6>
                        <h6>Additional Service & Parts Agents:</h6>
                        <div class="mb-4">
                            <div style="width:49%;display:inline-block">
                        ...
                        <div class="content para">
                            <p><strong>Dandenong Fuso</strong> stocks a wide range of genuine Fuso parts.</p>
                            ...
                            <p>In the event that a genuine part fails, Fuso will not only replace the faulty part, we’ll cover any additional damage caused by its failure, including labour costs if it is fitted by Daimler Trucks Dandenong Fuso.</p>
                            <p>Daimler Trucks Dandenong Fuso's qualified after sales personnel have the latest tools and equipment at their disposal to ensure they obtain the right part for the job, and that it will be fitted correctly.</p>
                            <p>Please call us directly or simply complete the online <strong>Spare Parts Enquiry Form</strong> and we'll contact you as soon as possible.</p>
                        </div>
                    </div>
                </div>
