                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="freightliner_tab">
                        <div class="content para">
                            ...
                            <p><sup>*</sup>Terms and conditions apply. Complimentary BestBasic 5 years/ 500,000kms (whichever occurs first from the date the vehicle is first registered) Service Plan available on eligible Cascadia vehicles (on-highway application up to 110,000Kg GCM and maintained as per Cascadia Supplementary Maintenance Manual Service Schedules II & III). On-highway applications up to 110,000Kg GCM, maintained as per Cascadia Supplementary Maintenance Manual Service Schedule I are capped at 5 years/3,000 hours (whichever occurs first from the date the vehicle is first registered). Valid for new vehicles purchased and delivered before 31 December 2023, unless extended. Covers all scheduled service work relevant to the vehicle as specified in the Cascadia Supplementary Maintenance Manual, and can only be carried out in an authorised Freightliner dealership. Please contact your authorised Freightliner dealership for a copy of the full terms and conditions including inclusions and exclusions of items covered under the BestBasic Service Plan. Freightliner is a registered trade mark of Daimler Trucks North America LLC, distributed in Australia and New Zealand by Daimler Truck and Bus Australia Pacific Pty Ltd ACN 618 413 282 / NZCN 8039364</p>
